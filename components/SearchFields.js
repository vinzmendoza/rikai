    ...
    <div className="flex flex-col gap-y-4">
      <div className="flex flex-col">
        ...
        <input
          ...
          id="englishMeaning"
          className="w-full px-2 py-1 transition duration-200 ease-in-out border rounded appearance-none border-neutral-600 bg-neutral-800 focus:outline-none focus:border-teal-400"
        />
      </div>
